	...
	public static function handleProjectVisualSettings($project_id, $user_id, $visual_settings_id, $arr, $arr_visual_settings) {
		...
		$res = DB::query("INSERT INTO ".DB::getTable('DEF_NODEGOAT_CUSTOM_PROJECT_VISUAL_SETTINGS')."
			...
			(
				...
				'".DBFunctions::strEscape($arr['name'])."',
				'".DBFunctions::strEscape($arr['description'])."',
					".((string)$arr_visual_settings['capture']['enable'] !== '' && $arr_visual_settings['capture']['enable'] !== $arr_default['capture']['enable'] ? (int)$arr_visual_settings['capture']['enable'] : 'NULL').",
					'".($arr_visual_settings['capture']['settings'] !== $arr_default['capture']['settings'] ? DBFunctions::strEscape(value2JSON($arr_visual_settings['capture']['settings'])) : '')."',
					".((string)$arr_visual_settings['dot']['show'] !== '' && $arr_visual_settings['dot']['show'] !== $arr_default['dot']['show'] ? (int)$arr_visual_settings['dot']['show'] : 'NULL').",
					'".($arr_visual_settings['dot']['color'] !== $arr_default['dot']['color'] ? str2Color($arr_visual_settings['dot']['color']) : '')."',
					".((string)$arr_visual_settings['dot']['opacity'] !== '' && $arr_visual_settings['dot']['opacity'] !== $arr_default['dot']['opacity'] ? (float)$arr_visual_settings['dot']['opacity'] : 'NULL').",
					...
					".(float)($arr_visual_settings['dot']['size']['min'] !== $arr_default['dot']['size']['min'] ? $arr_visual_settings['dot']['size']['min'] : '').",
					".(float)($arr_visual_settings['dot']['size']['max'] !== $arr_default['dot']['size']['max'] ? $arr_visual_settings['dot']['size']['max'] : '').",
					".(int)($arr_visual_settings['dot']['size']['start'] !== $arr_default['dot']['size']['start'] ? $arr_visual_settings['dot']['size']['start'] : '').",
					".(int)($arr_visual_settings['dot']['size']['stop'] !== $arr_default['dot']['size']['stop'] ? $arr_visual_settings['dot']['size']['stop'] : '').",
					'".($arr_visual_settings['dot']['stroke_color'] !== $arr_default['dot']['stroke_color'] ? str2Color($arr_visual_settings['dot']['stroke_color']) : '')."',
					".(float)($arr_visual_settings['dot']['stroke_opacity'] !== $arr_default['dot']['stroke_opacity'] ? $arr_visual_settings['dot']['stroke_opacity'] : '').",
					".((string)$arr_visual_settings['dot']['stroke_width'] !== '' && $arr_visual_settings['dot']['stroke_width'] !== $arr_default['dot']['stroke_width'] ? (float)$arr_visual_settings['dot']['stroke_width'] : 'NULL').",
					".((string)$arr_visual_settings['location']['show'] !== '' && $arr_visual_settings['location']['show'] !== $arr_default['location']['show'] ? (int)$arr_visual_settings['location']['show'] : 'NULL').",
					'".($arr_visual_settings['location']['color'] !== $arr_default['location']['color'] ? str2Color($arr_visual_settings['location']['color']) : '')."',
					".(float)($arr_visual_settings['location']['opacity'] !== $arr_default['location']['opacity'] ? $arr_visual_settings['location']['opacity'] : '').",
					".(float)($arr_visual_settings['location']['size'] !== $arr_default['location']['size'] ? $arr_visual_settings['location']['size'] : '').",
					".(int)($arr_visual_settings['location']['threshold'] !== $arr_default['location']['threshold'] ? $arr_visual_settings['location']['threshold'] : '').",
					".((string)$arr_visual_settings['location']['offset'] !== '' && $arr_visual_settings['location']['offset'] !== $arr_default['location']['offset'] ? (int)$arr_visual_settings['location']['offset'] : 'NULL').",
					...
					".((string)$arr_visual_settings['line']['show'] !== '' && $arr_visual_settings['line']['show'] !== $arr_default['line']['show'] ? (int)$arr_visual_settings['line']['show'] : 'NULL').",
					'".($arr_visual_settings['line']['color'] !== $arr_default['line']['color'] ? str2Color($arr_visual_settings['line']['color']) : '')."',
					".(float)($arr_visual_settings['line']['opacity'] !== $arr_default['line']['opacity'] ? $arr_visual_settings['line']['opacity'] : '').",
					".(float)($arr_visual_settings['line']['width']['min'] !== $arr_default['line']['width']['min'] ? $arr_visual_settings['line']['width']['min'] : '').",
					".(float)($arr_visual_settings['line']['width']['max'] !== $arr_default['line']['width']['max'] ? $arr_visual_settings['line']['width']['max'] : '').",
					".((string)$arr_visual_settings['line']['offset'] !== '' && $arr_visual_settings['line']['offset'] !== $arr_default['line']['offset'] ? (int)$arr_visual_settings['line']['offset'] : 'NULL').",
					".((string)$arr_visual_settings['hint']['show'] !== '' && $arr_visual_settings['hint']['show'] !== $arr_default['hint']['show'] ? (int)$arr_visual_settings['hint']['show'] : 'NULL').",
					'".($arr_visual_settings['hint']['color'] !== $arr_default['hint']['color'] ? str2Color($arr_visual_settings['hint']['color']) : '')."',
					".((string)$arr_visual_settings['hint']['opacity'] !== '' && $arr_visual_settings['hint']['opacity'] !== $arr_default['hint']['opacity'] ? (float)$arr_visual_settings['hint']['opacity'] : 'NULL').",
					".(float)($arr_visual_settings['hint']['size'] !== $arr_default['hint']['size'] ? $arr_visual_settings['hint']['size'] : '').",
					'".($arr_visual_settings['hint']['stroke_color'] !== $arr_default['hint']['stroke_color'] ? str2Color($arr_visual_settings['hint']['stroke_color']) : '')."',
					".(float)($arr_visual_settings['hint']['stroke_opacity'] !== $arr_default['hint']['stroke_opacity'] ? $arr_visual_settings['hint']['stroke_opacity'] : '').",
					".((string)$arr_visual_settings['hint']['stroke_width'] !== '' && $arr_visual_settings['hint']['stroke_width'] !== $arr_default['hint']['stroke_width'] ? (float)$arr_visual_settings['hint']['stroke_width'] : 'NULL').",
					".(float)($arr_visual_settings['hint']['duration'] !== $arr_default['hint']['duration'] ? $arr_visual_settings['hint']['duration'] : '').",
					".(float)($arr_visual_settings['hint']['delay'] !== $arr_default['hint']['delay'] ? $arr_visual_settings['hint']['delay'] : '').",
					".((string)$arr_visual_settings['geometry']['show'] !== '' && $arr_visual_settings['geometry']['show'] !== $arr_default['geometry']['show'] ? (int)$arr_visual_settings['geometry']['show'] : 'NULL').",
					'".($arr_visual_settings['geometry']['color'] !== $arr_default['geometry']['color'] ? str2Color($arr_visual_settings['geometry']['color']) : '')."',
					".((string)$arr_visual_settings['geometry']['opacity'] !== '' && $arr_visual_settings['geometry']['opacity'] !== $arr_default['geometry']['opacity'] ? (float)$arr_visual_settings['geometry']['opacity'] : 'NULL').",
					'".($arr_visual_settings['geometry']['stroke_color'] !== $arr_default['geometry']['stroke_color'] ? str2Color($arr_visual_settings['geometry']['stroke_color']) : '')."',
					".(float)($arr_visual_settings['geometry']['stroke_opacity'] !== $arr_default['geometry']['stroke_opacity'] ? $arr_visual_settings['geometry']['stroke_opacity'] : '').",
					".((string)$arr_visual_settings['geometry']['stroke_width'] !== '' && $arr_visual_settings['geometry']['stroke_width'] !== $arr_default['geometry']['stroke_width'] ? (float)$arr_visual_settings['geometry']['stroke_width'] : 'NULL').",
					".((string)$arr_visual_settings['settings']['map_show'] !== '' && $arr_visual_settings['settings']['map_show'] !== $arr_default['settings']['map_show'] ? (int)$arr_visual_settings['settings']['map_show'] : 'NULL').",
					...
					".((string)$arr_visual_settings['settings']['geo_info_show'] !== '' && $arr_visual_settings['settings']['geo_info_show'] !== $arr_default['settings']['geo_info_show'] ? (int)$arr_visual_settings['settings']['geo_info_show'] : 'NULL').",
					'".($arr_visual_settings['settings']['geo_background_color'] !== $arr_default['settings']['geo_background_color'] ? str2Color($arr_visual_settings['settings']['geo_background_color']) : '')."',
					".((string)$arr_visual_settings['settings']['geo_mode'] !== '' && $arr_visual_settings['settings']['geo_mode'] !== $arr_default['settings']['geo_mode'] ? (int)$arr_visual_settings['settings']['geo_mode'] : 'NULL').",
					".((string)$arr_visual_settings['settings']['geo_display'] !== '' && $arr_visual_settings['settings']['geo_display'] !== $arr_default['settings']['geo_display'] ? (int)$arr_visual_settings['settings']['geo_display'] : 'NULL').",
					...
					'".($arr_visual_settings['social']['dot']['color'] !== $arr_default['social']['dot']['color'] ? str2Color($arr_visual_settings['social']['dot']['color']) : '')."',
					".((string)$arr_visual_settings['social']['dot']['opacity'] !== '' && $arr_visual_settings['social']['dot']['opacity'] !== $arr_default['social']['dot']['opacity'] ? (float)$arr_visual_settings['social']['dot']['opacity'] : 'NULL').",
					".(float)($arr_visual_settings['social']['dot']['size']['min'] !== $arr_default['social']['dot']['size']['min'] ? $arr_visual_settings['social']['dot']['size']['min'] : '').",
					".(float)($arr_visual_settings['social']['dot']['size']['max'] !== $arr_default['social']['dot']['size']['max'] ? $arr_visual_settings['social']['dot']['size']['max'] : '').",
					".(int)($arr_visual_settings['social']['dot']['size']['start'] !== $arr_default['social']['dot']['size']['start'] ? $arr_visual_settings['social']['dot']['size']['start'] : '').",
					".(int)($arr_visual_settings['social']['dot']['size']['stop'] !== $arr_default['social']['dot']['size']['stop'] ? $arr_visual_settings['social']['dot']['size']['stop'] : '').",
					'".($arr_visual_settings['social']['dot']['stroke_color'] !== $arr_default['social']['dot']['stroke_color'] ? str2Color($arr_visual_settings['social']['dot']['stroke_color']) : '')."',
					".(float)($arr_visual_settings['social']['dot']['stroke_opacity'] !== $arr_default['social']['dot']['stroke_opacity'] ? $arr_visual_settings['social']['dot']['stroke_opacity'] : '').",
					".((string)$arr_visual_settings['social']['dot']['stroke_width'] !== '' && $arr_visual_settings['social']['dot']['stroke_width'] !== $arr_default['social']['dot']['stroke_width'] ? (float)$arr_visual_settings['social']['dot']['stroke_width'] : 'NULL').",
					".((string)$arr_visual_settings['social']['label']['show'] !== '' && $arr_visual_settings['social']['label']['show'] !== $arr_default['social']['label']['show'] ? (int)$arr_visual_settings['social']['label']['show'] : 'NULL').",
					".((string)$arr_visual_settings['social']['label']['threshold'] !== '' && $arr_visual_settings['social']['label']['threshold'] !== $arr_default['social']['label']['threshold'] ? (float)$arr_visual_settings['social']['label']['threshold'] : 'NULL').",
					...
					'".($arr_visual_settings['social']['label']['color'] !== $arr_default['social']['label']['color'] ? str2Color($arr_visual_settings['social']['label']['color']) : '')."',
					".(float)($arr_visual_settings['social']['label']['opacity'] !== $arr_default['social']['label']['opacity'] ? $arr_visual_settings['social']['label']['opacity'] : '').",
					".(float)($arr_visual_settings['social']['label']['size'] !== $arr_default['social']['label']['size'] ? $arr_visual_settings['social']['label']['size'] : '').",
					".((string)$arr_visual_settings['social']['line']['show'] !== '' && $arr_visual_settings['social']['line']['show'] !== $arr_default['social']['line']['show'] ? (int)$arr_visual_settings['social']['line']['show'] : 'NULL').",
					'".($arr_visual_settings['social']['line']['color'] !== $arr_default['social']['line']['color'] ? str2Color($arr_visual_settings['social']['line']['color']) : '')."',
					".(float)($arr_visual_settings['social']['line']['opacity'] !== $arr_default['social']['line']['opacity'] ? $arr_visual_settings['social']['line']['opacity'] : '').",
					".(float)($arr_visual_settings['social']['line']['width']['min'] !== $arr_default['social']['line']['width']['min'] ? $arr_visual_settings['social']['line']['width']['min'] : '').",
					".(float)($arr_visual_settings['social']['line']['width']['max'] !== $arr_default['social']['line']['width']['max'] ? $arr_visual_settings['social']['line']['width']['max'] : '').",
					".((string)$arr_visual_settings['social']['line']['arrowhead_show'] !== '' && $arr_visual_settings['social']['line']['arrowhead_show'] !== $arr_default['social']['line']['arrowhead_show'] ? (int)$arr_visual_settings['social']['line']['arrowhead_show'] : 'NULL').",
					...
					".((string)$arr_visual_settings['social']['settings']['disconnected_dot_show'] !== '' && $arr_visual_settings['social']['settings']['disconnected_dot_show'] !== $arr_default['social']['settings']['disconnected_dot_show'] ? (int)$arr_visual_settings['social']['settings']['disconnected_dot_show'] : 'NULL').",
					".((string)$arr_visual_settings['social']['settings']['include_location_references'] !== '' && $arr_visual_settings['social']['settings']['include_location_references'] !== $arr_default['social']['settings']['include_location_references'] ? (int)$arr_visual_settings['social']['settings']['include_location_references'] : 'NULL').",
					'".($arr_visual_settings['social']['settings']['background_color'] !== $arr_default['social']['settings']['background_color'] ? str2Color($arr_visual_settings['social']['settings']['background_color']) : '')."',
					".((string)$arr_visual_settings['social']['settings']['display'] !== '' && $arr_visual_settings['social']['settings']['display'] !== $arr_default['social']['settings']['display'] ? (int)$arr_visual_settings['social']['settings']['display'] : 'NULL').",
					".((string)$arr_visual_settings['social']['settings']['static_layout'] !== '' && $arr_visual_settings['social']['settings']['static_layout'] !== $arr_default['social']['settings']['static_layout'] ? (int)$arr_visual_settings['social']['settings']['static_layout'] : 'NULL').",
					".((string)$arr_visual_settings['social']['settings']['static_layout_interval'] !== '' && $arr_visual_settings['social']['settings']['static_layout_interval'] !== $arr_default['social']['settings']['static_layout_interval'] ? (float)$arr_visual_settings['social']['settings']['static_layout_interval'] : 'NULL').",
					...
					'".($arr_visual_settings['time']['bar']['color'] !== $arr_default['time']['bar']['color'] ? str2Color($arr_visual_settings['time']['bar']['color']) : '')."',
					".(float)($arr_visual_settings['time']['bar']['opacity'] !== $arr_default['time']['bar']['opacity'] ? $arr_visual_settings['time']['bar']['opacity'] : '').",
					'".($arr_visual_settings['time']['settings']['background_color'] !== $arr_default['time']['settings']['background_color'] ? str2Color($arr_visual_settings['time']['settings']['background_color']) : '')."',
					".((string)$arr_visual_settings['time']['settings']['relative_graph'] !== '' && $arr_visual_settings['time']['settings']['relative_graph'] !== $arr_default['time']['settings']['relative_graph'] ? (int)$arr_visual_settings['time']['settings']['relative_graph'] : 'NULL').",
					".((string)$arr_visual_settings['time']['settings']['cumulative_graph'] !== '' && $arr_visual_settings['time']['settings']['cumulative_graph'] !== $arr_default['time']['settings']['cumulative_graph'] ? (int)$arr_visual_settings['time']['settings']['cumulative_graph'] : 'NULL')."
			)
